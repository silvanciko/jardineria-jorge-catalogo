 ...
 * js/productos.js
 * -----------------------------------------------------------------------
 * Datos del catálogo. Este archivo es el RESPALDO del sitio: script.js
 * intenta traer los datos reales desde /api/data primero; si el
 * backend no responde, usa lo que está aquí — así el sitio nunca
 * se cae.
 * -----------------------------------------------------------------------
 */
...
export const PRODUCTS = {
  ...
  decoracion: [
    ...
    { id: "d2", name: "Cerco vivo artificial (m)", price: "S/ 28.00 / m", desc: "Panel de cerco vivo artificial, ideal para dar privacidad y verde instantáneo.", img: "", light: "", watering: "", size: "", potSize: "", location: "Exterior", difficulty: "", tags: ["exterior"], featured: false, comments: [] },
  ],
};

export const TIPS = {
  fertilizantes: ["Aplica fertilizante después de regar, nunca en tierra seca, para evitar quemar las raíces."],
  plantas: ["Las suculentas necesitan menos agua de la que la mayoría cree.", "Gira tus plantas de interior cada semana para que crezcan parejas hacia la luz."],
